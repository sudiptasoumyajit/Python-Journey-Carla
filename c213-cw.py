...
def number_of_vehicle():
    ...
    if len(all_vehicles) > 1:
        ...
        for each_car in all_vehicles: #complete this code
            if each_car.id != world.id: #complete this code
        ...
        for distance_of_car in sorted_vehicles: #complete this code
            if distance_of_car > 200.0 : #complete this code
                break
            vehicle_type = get_actor_display_name(get_distance_of_bot_vehicles)
            vehicle_data['vehicle_name'] = get_actor_display_name(vehicle)#complete this code
            vehicle_data['distance'] = vehicle_type#complete this code
            final_vehicle_result.append(vehicle_data) #complete this code
...
def car_control():
    ...
    time.sleep(3)
    dropped_vehicle.apply_control(carla.VehicleControl(hand_brake=True))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.Brake|carla.VehicleLightState.Interior|carla.VehicleLightState.LowBeam)) #Turn on Brake light
    time.sleep(5)
